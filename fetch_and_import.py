...
def main():
    ...
    path = kagglehub.dataset_download("elchemist/myscheme-india-govt-welfare-schemes")
    print("Path to dataset files:", path)

    # find the csv file in path
    csv_path = None
    ...
    # Delete existing listings/details but leave parsed_eligibility intact
    ...
    conn.commit()
    conn.close()
    print("Successfully imported", len(listings), "schemes into the local cache.")
